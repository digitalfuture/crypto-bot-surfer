...
export async function getTradeSignals({
  ...
  try {
    ...
    //
    // Buy signal
    // const btcUsdtTicker = mappedList.find(
    //   ({ primarySymbol }) => primarySymbol === "BTC"
    // );
    // const isBtcGrowing = btcUsdtTicker.priceChangePercent > 0;
    ...
    //   btcUsdtTicker.priceChangePercent
    // );
    // console.log("isBtcGrowing:", btcUsdtTicker.priceChangePercent > 0);
